...
>(({ className, variant = "outline", size = "icon", icon, ...props }, ref) => {
  ...
  const Icon = icon === undefined ? ArrowLeftIcon : ChevronLeftIcon;
...
>(({ className, variant = "outline", size = "icon", icon, ...props }, ref) => {
  ...
  const Icon = icon === undefined ? ArrowRightIcon : ChevronRightIcon;
  return (
    <Button
      ref={ref}
      variant={variant}
